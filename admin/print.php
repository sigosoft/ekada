...
$GT=$row['delivery_charge']+$row['GrandTotal']; 
                    ...
                    <table class="row">
                        <tr>
                            <td class="title col-md-3">
                                <img src="images/1531300564.jpg" style="width:100%; max-width:100px;">
                            </td>
     ...
     {?>
      ...
      <tr>
       <td><?php echo $data['ProductName'];?></td>
        ...
        <td><?php echo $data['gst_percentage']/2;?></td>
        <td><?php echo $data['gst_percentage']/2;?></td>
        <td><?php echo $data['gst_value'];?></td>
      ...
      <?php
       $total1= $data['Total'];
          ...
          <tfoot>
      <tr>
          <td colspan="6" style="text-align:right"><b>Total:</b></td><td><b> <?php echo $GT;?></b></td></tr>
          <tr>
          
          <td colspan="6" style="text-align:right">Delivery Charge:</td><td> <?php echo $row['delivery_charge'];?></td>
          </tr>
          <tr>
          
          <td colspan="6" style="text-align:right">CGST:</td><td> <?php echo $cg=$row['delivery_charge']*(9/100);?></td>
          </tr>
          <tr>
          
          <td colspan="6" style="text-align:right">SGST:</td><td> <?php echo $sg=$row['delivery_charge']*(9/100);?></td>
          </tr>
          <tr>
          
          <td colspan="6" style="text-align:right"><b>GRAND TOTAL:</b></td><td><b> <?php echo  $cg+$sg+$GT+$row['delivery_charge'];?></b></td>
          </tr>
    </tfoot>
