...
$query="UPDATE delivery_time SET 	delivery_time1='$deliverytime1',	delivery_time2='$deliverytime2',delivery_time3='$deliverytime3' WHERE time_id='1'";
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" method="POST"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" >
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="CategoryName"> Delivery Time 3 <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="deliverytime3" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="deliverytime3" placeholder="Delivery Time"   value="<?php echo $row['delivery_time3']; ?>" type="text">
                        </div>
                      </div>
