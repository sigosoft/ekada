...
$sql="INSERT INTO delivery_locations(place_name,district,latitude, longitude, date) VALUES ('$place','$district','$latitude', '$longitude',  '$date')";
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" method="POST" class="form-horizontal form-label-left">
                      ...
                      <div class="item form-group">
					   ...
					   <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="ProductMRP">Latitude
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
					    ...
					    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="ProductMRP">Longitude
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
