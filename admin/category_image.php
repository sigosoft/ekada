...
if(isset($_POST['submit']))
{
    ...
    $update="UPDATE category SET CategoryImage='$image' WHERE Category_Id='$Category_Id'";
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" method="POST"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" >
                       ...
                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="image">Category Image <span class="required">(600*600 pixel)</span>
                        </label>
