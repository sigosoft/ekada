...
if(isset($_POST['submit']))
{
    ...
    $update="UPDATE subcategory SET subcategory_image='$image' WHERE subcategory_id='$SubCategory_Id'";
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" method="POST"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" >
                       ...
                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="image">SubCategory Image <span class="required">(600*600 pixel)</span>
                        </label>
