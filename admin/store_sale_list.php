...
$sql="SELECT * FROM app_orders WHERE status='Delivered' AND StoreID='$StoreID' ORDER BY OrderID ASC";
$result=mysqli_query($conn,$sql);


$GetTotaled="SELECT(SELECT SUM(GrandTotal) FROM app_orders WHERE status='Delivered' AND StoreID='$StoreID') AS Total";
...
$sql="SELECT * FROM app_orders WHERE status='Delivered' AND StoreID='$StoreID' AND (DATE(Timestamp) >= '$From' AND DATE(Timestamp) <= '$To')";


$result=mysqli_query($conn,$sql);

$GetTotaled="SELECT(SELECT SUM(GrandTotal) FROM app_orders WHERE status='Delivered' AND StoreID='$StoreID' AND (DATE(Timestamp) >= '$From' AND DATE(Timestamp) <= '$To')) AS Total";
