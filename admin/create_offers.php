...
$query="INSERT INTO offer_image(OfferImage) VALUES ('$OfferImage')";
if (mysqli_query($conn, $query))
 {
    echo "<script> alert('Offer Image Added Successfully');window.location.href = 'manage_offers.php';</script>";
 } 
...
else 
{
    ...
    echo "<script> alert('Error');window.location.href = 'create_offers.php';</script>";
}
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" method="POST" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                       ...
                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="OfferImage"> Offer Image<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="OfferImage" class="form-control col-md-7 col-xs-12" name="OfferImage" placeholder="Offer Image" required="required" type="file">
                        </div>
                      </div>
