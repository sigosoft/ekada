...
$sql="UPDATE products SET CategoryID='$CategoryID', ProductName='$ProductName', ProductPrice='$ProductPrice', ProductMRP='$ProductMRP', ProductStatus='$ProductStatus' WHERE ProductID='$ProductID'";
...
$resulter     = mysqli_query($conn,"SELECT * from category WHERE Status='Active' AND CategoryID!='$LiveCatID'");
while ($rower = mysqli_fetch_array($resulter))
{
    echo "<option value=".$rower['CategoryID'].">".$rower['CategoryName']."</option>";
}
?>        
</select> 
                        </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="ProductPrice" class="form-control col-md-7 col-xs-12" value="<?php echo $row['ProductPrice']; ?>" name="ProductPrice" placeholder="Product Price" type="number">
                        </div>
                      </div>
