...
$sql="SELECT * FROM app_orders WHERE OrderID='$OrderID' AND StoreID='$StoreID'";
$result=mysqli_query($conn,$sql);
$row=mysqli_fetch_assoc($result);
$GT=$row['delivery_charge']+$row['GrandTotal']; 

$order_items=mysqli_query($conn,"SELECT * FROM app_order_items WHERE OrderID='$OrderID' AND store_id='$StoreID' ");
    ...
    <tbody>
     ...
     <tfoot>
      <tr>
          ...
          <tr><tr>
          <td colspan="6" style="text-align:right"><b>Grand Total:</b></td><td><b>&#8377; <?php echo $GT;?></b></td></tr>
