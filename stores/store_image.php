...
if(isset($_POST['submit']))
{
    ...
    $update="UPDATE stores SET StoreImage='$image' WHERE StoreID='$StoreID'";
    ...
    echo "<script> alert('Upload Error');window.location.href = 'manage_stores.php';</script>";
                  ...
                  <div class="x_content">
                    ...
                    <form id="demo-form2" method="POST"  enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" >
                       ...
                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="image">Store Image <span class="required"></span>
                        </label>
