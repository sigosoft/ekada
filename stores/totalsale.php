...
$sql1="SELECT * FROM app_orders WHERE status='Delivered'  AND StoreID='$StoreID' AND date='$date1'";
...
$sql="SELECT * FROM app_orders WHERE status='Delivered'  AND StoreID='$StoreID' AND date='$date'";
